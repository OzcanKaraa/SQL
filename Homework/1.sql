...
5- "employees_bckp " tablosundaki "salary" sütununun veri tipini NUMBER(10, 2)'den
...
6-"departments_bckp" tablosundaki "department_name" sütununun adını "dept_name" olarak
değiştirin.
